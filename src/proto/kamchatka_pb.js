...
goog.exportSymbol('proto.main.GetSatelliteAlertsRequest', null, global);
goog.exportSymbol('proto.main.GetSatelliteAlertsResponse', null, global);
goog.exportSymbol('proto.main.Group', null, global);
goog.exportSymbol('proto.main.SatelliteAlert', null, global);
 ...
 * @constructor
 */
proto.main.GetSatelliteAlertsRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.main.GetSatelliteAlertsRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.main.GetSatelliteAlertsRequest.displayName = 'proto.main.GetSatelliteAlertsRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.main.GetSatelliteAlertsResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.main.GetSatelliteAlertsResponse.repeatedFields_, null);
};
goog.inherits(proto.main.GetSatelliteAlertsResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.main.GetSatelliteAlertsResponse.displayName = 'proto.main.GetSatelliteAlertsResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.main.SatelliteAlert = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.main.SatelliteAlert, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.main.SatelliteAlert.displayName = 'proto.main.SatelliteAlert';
}
 ...
 * @return {!Object}
 */
proto.main.GetSatelliteAlertsRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.main.GetSatelliteAlertsRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.main.GetSatelliteAlertsRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.main.GetSatelliteAlertsRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.main.GetSatelliteAlertsRequest}
 */
proto.main.GetSatelliteAlertsRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.main.GetSatelliteAlertsRequest;
  return proto.main.GetSatelliteAlertsRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.main.GetSatelliteAlertsRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.main.GetSatelliteAlertsRequest}
 */
proto.main.GetSatelliteAlertsRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.main.GetSatelliteAlertsRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.main.GetSatelliteAlertsRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.main.GetSatelliteAlertsRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.main.GetSatelliteAlertsRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
 ...
 * @const
 */
proto.main.GetSatelliteAlertsResponse.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.main.GetSatelliteAlertsResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.main.GetSatelliteAlertsResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.main.GetSatelliteAlertsResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.main.GetSatelliteAlertsResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    satellitealertsList: jspb.Message.toObjectList(msg.getSatellitealertsList(),
    proto.main.SatelliteAlert.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.main.GetSatelliteAlertsResponse}
 */
proto.main.GetSatelliteAlertsResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.main.GetSatelliteAlertsResponse;
  return proto.main.GetSatelliteAlertsResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.main.GetSatelliteAlertsResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.main.GetSatelliteAlertsResponse}
 */
proto.main.GetSatelliteAlertsResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new proto.main.SatelliteAlert;
      reader.readMessage(value,proto.main.SatelliteAlert.deserializeBinaryFromReader);
      msg.addSatellitealerts(value);
      break;
    default:
      reader.skipField();
      break;
 ...
 * @return {!Uint8Array}
 */
proto.main.GetSatelliteAlertsResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.main.GetSatelliteAlertsResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.main.GetSatelliteAlertsResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.main.GetSatelliteAlertsResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getSatellitealertsList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.main.SatelliteAlert.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!Array<!proto.main.SatelliteAlert>}
 */
proto.main.GetSatelliteAlertsResponse.prototype.getSatellitealertsList = function() {
  return /** @type{!Array<!proto.main.SatelliteAlert>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.main.SatelliteAlert, 1));
};


/**
 * @param {!Array<!proto.main.SatelliteAlert>} value
 * @return {!proto.main.GetSatelliteAlertsResponse} returns this
*/
proto.main.GetSatelliteAlertsResponse.prototype.setSatellitealertsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};


/**
 * @param {!proto.main.SatelliteAlert=} opt_value
 * @param {number=} opt_index
 * @return {!proto.main.SatelliteAlert}
 */
proto.main.GetSatelliteAlertsResponse.prototype.addSatellitealerts = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.main.SatelliteAlert, opt_index);
};
 ...
 * @return {!proto.main.GetSatelliteAlertsResponse} returns this
 */
proto.main.GetSatelliteAlertsResponse.prototype.clearSatellitealertsList = function() {
  return this.setSatellitealertsList([]);
};
 ...
 * @return {!Object}
 */
proto.main.SatelliteAlert.prototype.toObject = function(opt_includeInstance) {
  return proto.main.SatelliteAlert.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.main.SatelliteAlert} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.main.SatelliteAlert.toObject = function(includeInstance, msg) {
  var f, obj = {
    image: jspb.Message.getFieldWithDefault(msg, 1, ""),
    category: jspb.Message.getFieldWithDefault(msg, 2, ""),
    time: jspb.Message.getFieldWithDefault(msg, 3, ""),
    coordinates: jspb.Message.getFieldWithDefault(msg, 4, "")
  };
 ...
 * @return {!proto.main.SatelliteAlert}
 */
proto.main.SatelliteAlert.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.main.SatelliteAlert;
  return proto.main.SatelliteAlert.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.main.SatelliteAlert} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.main.SatelliteAlert}
 */
proto.main.SatelliteAlert.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.main.SatelliteAlert.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.main.SatelliteAlert.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.main.SatelliteAlert} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.main.SatelliteAlert.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getImage();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.main.SatelliteAlert.prototype.getImage = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.main.SatelliteAlert} returns this
 */
proto.main.SatelliteAlert.prototype.setImage = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.main.SatelliteAlert.prototype.getCategory = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.main.SatelliteAlert} returns this
 */
proto.main.SatelliteAlert.prototype.setCategory = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.main.SatelliteAlert.prototype.getTime = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.main.SatelliteAlert} returns this
 */
proto.main.SatelliteAlert.prototype.setTime = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};


/**
 * optional string coordinates = 4;
 * @return {string}
 */
proto.main.SatelliteAlert.prototype.getCoordinates = function() {
 ...
 * @return {!proto.main.SatelliteAlert} returns this
 */
proto.main.SatelliteAlert.prototype.setCoordinates = function(value) {
